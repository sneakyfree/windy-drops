...
EXCLUDE_FILES=(
  # Design docs that legitimately reference banned hosts as "do-not-use"
  # warnings (e.g. DNA_STRAND_MASTER_PLAN.md noting that api.windyword.ai
  # is the zombie host, NOT the canonical one).
